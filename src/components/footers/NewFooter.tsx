...
export default function NewFooter() {
  ...
  return (
    <footer className="bg-ternary text-[#8d8d8d] flex items-center justify-center px-6 py-12">
      <Container className="w-full max-w-7xl  px-10 md:px-16">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-5">
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-2 text-sm leading-6 flex flex-col">
              <p>{webSiteFooterData.contact?.links[0].label}</p>
              <Link href={webSiteFooterData.contact.links[1].href}>
                {webSiteFooterData.contact?.links[1].label}
              </Link>
              <Link href={webSiteFooterData.contact.links[2].href}>
                {webSiteFooterData.contact?.links[2].label}
              </Link>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-between">
            ...
            <Link
              ...
              className="mt-10 w-fit rounded-md bg-[#d2ab62] px-6 py-4 text-sm font-semibold uppercase tracking-wider text-black transition hover:opacity-90"
            >
        ...
        <div className="mt-14 flex flex-col gap-4 border-t border-[#1b2a25] pt-6 text-xs text-[#6f6f6f] md:flex-row md:items-center md:justify-between">
          ...
          <p>Park Estate, Hathipaon Road, Mussoorie, Uttarakhand 248179</p>
        </div>
      </Container>
    </footer>
  );
