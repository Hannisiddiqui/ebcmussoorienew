...
const FeatureCard = ({ id, title, description, icon }: TFeatureCard) => {
  return (
    <div className="group flex flex-col items-center bg-[#1E2E21] rounded-sm relative overflow-hidden border border-secondary/20 px-4 py-6 transition-all duration-500 hover:-translate-y-2">
      {/* GLOW EFFECT */}
