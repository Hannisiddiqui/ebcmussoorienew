      ...
      <div className=" text-white content-class">
        ...
        <div className="mt-4">
          <div className="space-y-3">
            <p>
              At EBC Mussoorie, accessible from https://ebcmussoorie.com, one of
              our main priorities is the privacy of our visitors. This Privacy
              Policy document contains types of information that is collected
              and recorded by EBC Mussoorie and how we use it.
            </p>
            ...
            <p>
              ...
              that they shared and/or collect in EBC Mussoorie.
            </p>
          </div>
          ...
          <div className="mt-8 space-y-5">
            ...
            <div>
              ...
              <p className="mt-10">
                EBC Mussoorie follows a standard procedure of using log files.
            ...
            <div>
              ...
              <p className="mt-8">
                ...
                respective advertisements and links that appear on EBC
                Mussoorie, which are sent directly to users’ browser. They
              ...
              <p className="mt-12">
                Note that EBC Mussoorie has no access to or control over these
            ...
            <div>
              ...
              <p>
                ...
                and instructions about how to opt-out of certain option
              </p>
            ...
            <div>
              ...
              <p className="mt-6">
                EBC Mussoorie does not knowingly collect any Personal
