...
import { FillFaceBookIcon, OutLineInstagramIcon, TripadvisorIcon, YouTube } from "@/utils/icons";
    ...
    <SectionWithContainer sectionClassName="bg-background-1">
      <div className="flex flex-col gap-4 items-center justify-center h-[60vh]">
        ...
        <div className="flex flex-col w-full items-center  justify-center gap-4">
          <h1 className="lg:text-4xl font-primary text-2xl font-semibold text-primary">
            Thanks for submitting!
          </h1>
          <p className="lg:text-2xl italic text-primary">
            we will get back to you shortly!
          </p>
          <button
            className="bg-primary font-primary-medium text-white w-max py-2 px-6 lg:text-[1.375rem]/[2rem] text-xl rounded-md hover:bg-green-700 transition duration-200"
