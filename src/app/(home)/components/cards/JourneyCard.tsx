...
const JourneyCard: React.FC<JourneyProps["items"][0]> = ({
  ...
  return (
    <div className="w-full  relative aspect-[4/5.25] rounded-sm overflow-hidden">
      <Image src={image} alt={title} fill className="object-cover" sizes="100vw" style={{
        objectPosition: "center bottom",
        objectViewBox: "0 0 100% 100%",
      }} />
      <div className="absolute z-10 inset-x-0 bottom-0 h-70 bg-linear-to-b from-black/0 to-47% to-black/85" />
