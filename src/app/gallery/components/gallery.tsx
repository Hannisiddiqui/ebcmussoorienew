...
export default function Gallery({ galleryImages }: Props) {
    ...
    return (
        ...
        >
            ...
            <div className="mb-12 flex flex-wrap justify-center gap-12 uppercase py-6">
                {categories.map((cat, index) => (
                    <button
                        key={index}
                        onClick={() => setSelected(cat)}
                        className={`h-[38px] px-4 border-b transition-all duration-300 font-body text-[14px] ${selected === cat
